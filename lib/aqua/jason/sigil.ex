defmodule Aqua.Jason.Sigil do
  ...
  defmacro sigil_j({:<<>>, _meta, [string]}, modifiers) when is_binary(string) do
    Macro.escape(Aqua.Jason.decode!(string, mods_to_opts(modifiers)))
  end

  defmacro sigil_j(term, modifiers) do
    quote(do: Aqua.Jason.decode!(unquote(term), unquote(mods_to_opts(modifiers))))
  end
  ...
  @spec mods_to_opts(charlist) :: [Aqua.Jason.decode_opt()]
