defmodule Aqua.Jason.OrderedObject do
  @doc """
...
defimpl Enumerable, for: Aqua.Jason.OrderedObject do
...
defimpl Aqua.Jason.Encoder, for: Aqua.Jason.OrderedObject do
  def encode(%{values: values}, opts) do
    Aqua.Jason.Encode.keyword(values, opts)
  end
end
